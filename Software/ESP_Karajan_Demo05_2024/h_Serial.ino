void serialRun() {
  switch (serialPage) {
    ...
    case 'D':                               //Debug report
      Console1.printf("A0: %i BatV:%05.2fV BatI:%05.3fA V %% IOhm:%5.4fR \n", analogRead(A0), payload.BatV, payload.BatI, payload.IOhm);
      break;
