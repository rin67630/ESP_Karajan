...
void loop()
{
  ...
  instantData(); // This part is processed with the highest priority. It should ony contain asynchonus communication tasks that are paced from an external device and cannot wait
